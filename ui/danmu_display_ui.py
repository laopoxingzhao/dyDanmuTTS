...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                             ...
                             QListWidget, QSplitter, QLineEdit, QCheckBox, 
...
class DanmuDisplayWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        filter_layout.addWidget(keyword_label, 2, 1)
        filter_layout.addWidget(self.keyword_input, 2, 2)
        
        # 清屏按钮
        self.clear_button = QPushButton("清屏")
        self.clear_button.clicked.connect(self.clear_screen)
        filter_layout.addWidget(self.clear_button, 3, 2)
